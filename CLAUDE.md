...
Sistema de postulación a licitaciones y compras ágiles en Mercado Público (Chile). Stack: Vite + React + TypeScript + Tailwind + shadcn/ui + Supabase. Ver también `.cursorrules` para identidad y sistemas.

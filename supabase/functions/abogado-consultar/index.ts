...
// Bloque que se agrega al final de las guías de cobranza (carta_cobranza y requerimiento_pago).
// La carta va al deudor; los intereses/comisión se cobran con una NOTA DE DÉBITO EXENTA que el
// propio proveedor debe emitir en su facturación electrónica del SII (FirmaVB aún no integra el SII).
...
const TIPOS_DOC: Record<string, { titulo: string; guia: string }> = {
  ...
  carta_cobranza: {
    ...
    guia: `Es una carta formal de cobro dirigida al deudor por una factura vencida e impaga, lista para imprimir/descargar en PDF y enviar. Estructura: identifica la factura (número, fecha de emisión y de recepción, monto), el bien o servicio entregado y su recepción conforme; indica los días de atraso respecto del plazo legal o pactado; desarrolla los FUNDAMENTOS DE DERECHO (no bastan menciones sueltas: explica por qué obliga a pagar); requiere el pago dentro de un plazo breve (por ejemplo 5 días hábiles) e indica los medios de pago; y advierte, de forma profesional y sin amenazar, las consecuencias del no pago.
FUNDAMENTOS DE DERECHO — desarróllalos con solidez, citando cada norma por su nombre y número aunque no aparezca en las FUENTES (todo esto es correcto en Chile):
(a) Ley 21.131 sobre pago a treinta días: toda factura debe pagarse en un máximo de 30 días corridos desde su recepción (salvo acuerdo excepcional en contrario dentro de los márgenes legales). Vencido ese plazo, el deudor queda en mora de pleno derecho y la deuda devenga (i) intereses moratorios a la tasa de interés corriente para operaciones no reajustables que fija la Comisión para el Mercado Financiero (CMF), y (ii) una comisión fija por recuperación y cobranza equivalente al 1% del saldo insoluto.
(b) Código Civil: el artículo 1551 constituye en mora al deudor por el solo vencimiento del plazo estipulado; y el artículo 1559 establece que en las obligaciones de dinero la indemnización por la mora se traduce en el pago de intereses. Esto refuerza que el atraso no es gratuito.
(c) Ley 18.010: el interés corriente aplicable es el que certifica mensualmente la CMF para operaciones de crédito de dinero no reajustables.
(d) Ley 19.983: la copia cedible de la factura, recibida y no reclamada dentro de los 8 días corridos, tiene mérito ejecutivo; es decir, habilita a iniciar de inmediato un juicio ejecutivo de cobro, con embargo de bienes, sin necesidad de un juicio declarativo previo.
(e) Si el deudor es un organismo del Estado, rige además el deber de pago oportuno de la Ley 19.886 y su Reglamento (Decreto 250/2004 hoy D.661/2024): el proveedor puede reclamar el no pago ante la propia institución, ante ChileCompra (gestión de pago / ProntoPago) y presentar los antecedentes a la Contraloría General de la República por la eventual responsabilidad administrativa de los funcionarios que retienen el pago.
Tono firme pero cordial: es el primer requerimiento formal y busca cobrar sin romper la relación comercial. No inventes montos de interés exactos: si no se entregan, refiérete a "los intereses y la comisión que la ley establece". Máximo 650 palabras.
${NOTA_DEBITO_INSTR}`
  },
  requerimiento_pago: {
    titulo: "Requerimiento pre-judicial de pago (última gestión formal antes de demandar)",
    guia: `Es el requerimiento FORMAL Y FINAL de pago antes de ejercer acciones judiciales de cobro, listo para imprimir/descargar en PDF y enviar. Estructura: identifica la factura y su recepción conforme; expone el atraso y el monto adeudado; desarrolla los FUNDAMENTOS DE DERECHO; requiere el pago íntegro (capital más intereses y comisión legal) dentro de un plazo perentorio (por ejemplo 5 días hábiles); y advierte expresamente que, de no pagarse, se ejercerán las acciones legales de cobro que la ley franquea.
FUNDAMENTOS DE DERECHO — desarróllalos con solidez, citando cada norma por su nombre y número (correcto en Chile):
(a) Ley 19.983: la copia cedible de la factura recibida y no reclamada dentro de los 8 días corridos constituye título ejecutivo, habilitando una demanda ejecutiva de cobro con embargo de bienes, sin juicio declarativo previo.
(b) Ley 21.131 (pago a 30 días): vencido el plazo, el deudor queda en mora de pleno derecho y adeuda intereses moratorios a la tasa de interés corriente de la CMF más una comisión de recuperación de costos de cobranza del 1% del saldo insoluto.
(c) Código Civil, artículos 1551 (mora por el solo vencimiento del plazo) y 1559 (en obligaciones de dinero la indemnización de la mora son los intereses); y Ley 18.010 sobre el interés corriente.
(d) Para deudores del Estado: deber de pago oportuno de la Ley 19.886 y su Reglamento, con reclamo ante ChileCompra (ProntoPago) y presentación de antecedentes a la Contraloría General de la República.
Deja claro que este es el último requerimiento amistoso antes de demandar. Tono formal y enérgico, sin insultos ni amenazas ilegítimas. No inventes montos de interés exactos: si no se entregan, refiérete a "los intereses y la comisión que la ley establece". Máximo 700 palabras.
${NOTA_DEBITO_INSTR}`
  },

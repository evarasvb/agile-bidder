...
{"titulo":"Matriz de postulación · código · nombre corto","resumen":"2 frases: qué es y veredicto",
 "admisibilidad":[{"requisito":"...","regla":"qué exige exactamente (cifra, plazo, formato)","fuente":"sección o numeral de las bases, o 'ficha'","estado":"pendiente|cumple|no_cumple|revisar","nota":"cómo cumplirlo o qué falta según los documentos del proveedor"}],
 "evaluacion":[{"criterio":"...","como_se_puntua":"fórmula o escala","ponderacion":"% o puntos","puntaje_max":"...","que_hacer":"qué hacer para el máximo puntaje","fuente":"..."}],
 ...
 "fechas":[{"hito":"...","fecha":"..."}]}
Usa SOLO los datos entregados (bases, ficha, documentos del proveedor, perfil de la empresa). Si hay DOCUMENTOS DEL PROVEEDOR, úsalos para marcar estado cumple/ok y anotar en "nota" lo que ya está listo y lo que falta. Si algo no está en las fuentes, estado "revisar" y nota "revisar en bases". Máximo 25 filas por lista. Español chileno, directo, cifras exactas, sin inventar.`;

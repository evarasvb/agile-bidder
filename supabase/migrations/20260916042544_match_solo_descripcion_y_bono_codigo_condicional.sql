...
-- de la base: match_sim ahora da un bono solo cuando el código de producto
-- coincide Y además hay similitud de texto mínima (antes el código solo ya
-- alcanzaba, generando falsos positivos), y nombre_norm ahora prioriza la
-- descripción del producto por sobre el nombre libre del pedido.

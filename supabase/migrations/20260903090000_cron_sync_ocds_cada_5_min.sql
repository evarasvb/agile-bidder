-- Acelera el relleno OCDS: cada 5 min y 200 procesos por tramo y 120 reintentos (junio trae más adjudicaciones por tramo; el
...
select cron.schedule('sync-ocds-cron', '*/5 * * * *', $$
  select net.http_post(
    ...
    body := '{"lote_mes": 200, "recientes": 120}'::jsonb, timeout_milliseconds := 150000);
$$);

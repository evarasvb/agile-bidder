...
CREATE TABLE IF NOT EXISTS public.compras_agiles (
...
DROP TRIGGER IF EXISTS update_compras_agiles_updated_at ON public.compras_agiles;
...
-- Insert sample data (solo si la tabla tiene la estructura correcta)
DO $$ 
BEGIN
  IF EXISTS (
    ...
    INSERT INTO public.compras_agiles (codigo, nombre, organismo, monto_estimado, fecha_cierre, estado, region, descripcion, match_encontrado, match_score)
    VALUES 

-- Job: cada 10 minutos carga hasta 15 días pendientes (~6 s por día) (ambos tipos) del buscador de reclamos.
-- Primero rellena los últimos 365 días (~4 h) y después solo carga el día anterior.
